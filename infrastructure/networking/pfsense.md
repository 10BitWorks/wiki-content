...
3. **Silent Auth:** Modern devices open a background window. If the member is already logged in to [kanidm](/app-services/self-hosted/kanidm), the portal auto-authorizes the MAC address instantly.
