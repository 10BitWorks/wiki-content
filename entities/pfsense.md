...
updated: 2026-06-14
type: entity
tags: [pfsense, network, access-control]
---
...
3. **Silent Auth:** Modern devices open a background window. If the member is already logged in to [[kanidm]], the portal auto-authorizes the MAC address instantly.
